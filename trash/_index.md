...
This site is still very much under development. In the **Reading Marx** section (click on the button above right) you will find separate sections for each of Marx’s main works: *Grundrisse*, the 1861-63 Manuscript, *Capital*, and so on. If you click on one of those links, you will be taken to a list of posts. Each post (click on the link) consists of an introductory paragraph and a link to a longer text in pdf format.

Note, however, that I won’t transfer any of the *Capital* material from the old Wordpress blog until I get to the end of the 1861-63 Manuscript; this is why I’ll keep the Wordpress blog live for the time being.

In the **Other Writers** section you will find my reading notes for texts not by Marx.

The **Writing** section is where I post my own writings (things that are not reading notes); here, for example, you’ll find an explanation of why I decided to read Marx when I did. I used to put my writings on another Wordpress blog that I maintained alongside the old Reading Marx one (*Ed George's Other Blog*: https://edgeorgesotherblog.wordpress.com/), but I’ll no longer post any new material there. Eventually, I’ll transfer what’s there and worth keeping over to this new site; in the meantime I’ll keep this other old blog live for the time being as well.

The **Texts** section is intended to be a place for me to post texts written by other people: things that I think are important but that are not easily available elsewhere. The first thing I intend to put in this section are a set of (in my opinion path-breaking) south Wales IMG discussion documents from the late 1970s and early 80s which deal with the national question in Wales.
...
To contact me, write to me at edgeorge1963@gmail.com.
